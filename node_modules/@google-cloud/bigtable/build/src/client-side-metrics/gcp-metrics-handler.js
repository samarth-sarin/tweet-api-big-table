...
exports.GCPMetricsHandler = void 0;
const exporter_1 = require("./exporter");
const Resources = require("@opentelemetry/resources");
const ResourceUtil = require("@google-cloud/opentelemetry-resource-util");
const sdk_metrics_1 = require("@opentelemetry/sdk-metrics");
const { Aggregation, ExplicitBucketHistogramAggregation, MeterProvider, Histogram, PeriodicExportingMetricReader, } = require('@opentelemetry/sdk-metrics');
const os = require("os");
const crypto = require("crypto");
const client_side_metrics_attributes_1 = require("./client-side-metrics-attributes");
/**
 ...
 */
function createInstruments(exporter) {
    ...
    ].map(name => new sdk_metrics_1.View({
        instrumentName: name,
        name,
    ...
    return {
        operationLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/operation_latencies', {
        ...
        attemptLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/attempt_latencies', {
        ...
        retryCount: meter.createCounter('bigtable.googleapis.com/internal/client/retry_count', {
        ...
        applicationBlockingLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/application_latencies', {
        ...
        firstResponseLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/first_response_latencies', {
        ...
        serverLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/server_latencies', {
        ...
        connectivityErrorCount: meter.createCounter('bigtable.googleapis.com/internal/client/connectivity_error_count', {
        ...
        clientBlockingLatencies: meter.createHistogram('bigtable.googleapis.com/internal/client/throttling_latencies', {
...
class GCPMetricsHandler {
    ...
    constructor(options) {
        ...
        const exporter = new exporter_1.CloudMonitoringExporter(options);
    ...
    onOperationComplete(data) {
        ...
        if (data.metricsCollectorData.method === client_side_metrics_attributes_1.MethodName.READ_ROWS ||
            data.metricsCollectorData.method === client_side_metrics_attributes_1.MethodName.READ_ROW) {
        ...
        if (data.applicationLatency) {
            otelInstruments.applicationBlockingLatencies.record(data.applicationLatency, commonAttributes);
        }
    ...
    onAttemptComplete(data) {
        ...
        otelInstruments.connectivityErrorCount.add(data.connectivityErrorCount, commonAttributes);
...
exports.GCPMetricsHandler = GCPMetricsHandler;
//# sourceMappingURL=gcp-metrics-handler.js.map